...
public class HttpRequestHandler extends SimpleChannelInboundHandler<Object> {
     ...
     * Only HTTP requests are processed here, and WebSocket requests are handed over to the next processor.
     */
    @Override
    ...
    /**
     * Description: Processing Http requests, mainly to complete the upgrade from HTTP protocol to Websocket protocol
     * @param ctx
     * @param req
     */
    ...
    /**
     * Description: Exception handling, close the channel
     */
    @Override
